...
| **SVG data-URI text via Image controls** (app already has the UDF machinery) | OUT for text | Same client-font constraint as HTML, plus the audit's PERF-10 regeneration lesson. SVG stays for icons. |
